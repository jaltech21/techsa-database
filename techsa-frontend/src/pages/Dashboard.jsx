...
function Sidebar({ active, setActive, currentUser, onLogout }) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-56 bg-white border-r border-gray-100 flex flex-col z-20 shadow-sm">
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 ml-56 flex flex-col min-h-screen">
        {/* Top bar */}
        <header className="sticky top-0 z-10 bg-white border-b border-gray-100 h-16 flex items-center justify-between px-6 shadow-sm">
        ...
        {/* Page content */}
        <main className="flex-1 px-6 py-7 space-y-5 max-w-5xl w-full">
